...
short_description: Fibre Channel Qos policy configuration for Cisco Intersight
description:
  - Fibre Channel Qos policy configuration for Cisco Intersight.
  - Used to configure Fibre Channel Qos Policy on Cisco Intersight managed devices.
...
- name: Configure Fibre Channel QoS Policy
  cisco.intersight.intersight_fibre_channel_qos_policy:
    ...
    organization: DevNet
    name: COS-FCQOS
    description: Fibre Channel Qos policy for COS
    tags:
      - Key: Site
        Value: RCDN
    cos: 1
